  ...
  return (
    <div className="p-6 bg-gradient-to-r from-green-100 to-green-200 rounded-lg">
      ...
      <div className="mb-6 grid grid-cols-2 gap-6">
        {/* Date */}
        <div>
          <label htmlFor="date" className="block mb-2 text-gray-800">
            Date
          </label>
          <input
            type="date"
        ...
        {/* Start Time */}
        <div>
          <label htmlFor="startTime" className="block mb-2 text-gray-800">
            Start Time
          </label>
          <input
            type="time"
        ...
        {/* End Time */}
        <div>
          <label htmlFor="endTime" className="block mb-2 text-gray-800">
            End Time
          </label>
          <input
            type="time"
        ...
        {/* Break Duration */}
        <div>
          <label htmlFor="breakDuration" className="block mb-2 text-gray-800">
            Break Duration
          </label>
          <select
            id="breakDuration"
      ...
      <div className="mb-6">
        <button
          type="button"
          className="w-full bg-green-800 text-white px-3 py-2 rounded-md"
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {timeSlots.map((slot, index) => (
            <div
              key={index}
              className="flex items-center bg-gray-200 px-3 py-2 rounded-md"
            >
              {slot}
              <FontAwesomeIcon
                icon={faTrashAlt}
